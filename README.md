...
[![R-CMD-check](https://github.com/ready4-dev/heterodox/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ready4-dev/heterodox/actions/workflows/R-CMD-check.yaml)
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.5751193.svg)](https://doi.org/10.5281/zenodo.5751193)
[![CRAN status](https://www.r-pkg.org/badges/version/heterodox)](https://CRAN.R-project.org/package=heterodox)
<!-- badges: end -->

Tools to explore heterogeneity in quality of life data.  This
development version of the heterodox package has been made available
